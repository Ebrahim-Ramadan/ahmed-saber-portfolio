      ...
      <p className='font-bold text-center text-lg md:text-xl group-hover:underline'>
        ...
        <Out/>
          ...
          {WorkDetails.map((item) => (
              ...
              <div
                  key={item.ID}
                  className='gap-2 flex flex-col hover:bg-neutral-950 hover:bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))] bg-black col-span-1 rounded-3xl border border-2 border-gray-400 hover:border-white transition duraiton-200 p-4'>
              <div 
